...
var theme = {
    ...
    fontWeightLight: 300,
    borderRadius: '2px',
    fontColor: polished_1.darken(0.8, '#fff'),
    colorOffsetDark: colorOffsetDark,
    colorGrayLight: polished_1.darken(0.13, '#fff'),
    zIndexMax: 1000,
    zIndexModal: 1400
};
var namedColors = {
...
var themeColors = {
    ...
    bodyAccentColor: {
        value: polished_1.darken(0.8, '#fff'),
        replacement: 'colors.gray[1]'
    },
    bodyOffsetColor: {
        value: polished_1.darken(0.53, '#fff'),
    ...
    colorMuted: { value: polished_1.darken(0.5125, '#fff'), replacement: 'colors.gray[4]' },
    colorSmoke: { value: '#f2f2f2', replacement: 'colors.gray[9]' },
    colorBlue: { value: '#2f7bbf', replacement: 'colors.blue[4]' },
    colorBlueLight: {
        value: polished_1.lighten(colorOffsetLight, '#2f7bbf'),
        replacement: 'colors.blue[5]'
    },
    colorBlueDark: {
        value: polished_1.darken(colorOffsetDark, '#2f7bbf'),
        replacement: 'colors.blue[3]'
    },
    colorOrange: { value: '#ff7900', replacement: 'colors.orange[6]' },
    colorOrangeLight: {
        value: polished_1.lighten(colorOffsetLight, '#ff7900'),
        replacement: 'colors.orange[7]'
    },
    colorOrangeDark: {
        value: polished_1.darken(colorOffsetDark, '#ff7900'),
        replacement: 'colors.orange[5]'
    },
    colorGray: { value: polished_1.darken(0.5125, '#fff'), replacement: 'colors.gray[4]' },
    colorGrayLight: {
        value: polished_1.darken(0.13, '#fff'),
        replacement: 'colors.gray[7]'
    },
    colorGrayLightOnboarding: { value: '#F7F7F7', replacement: 'colors.gray[9]' },
    colorGrayDark: { value: polished_1.darken(0.8, '#fff'), replacement: 'colors.gray[1]' },
    colorGrayBorder: { value: '#666', replacement: 'colors.gray[3]' },
    colorGreen: { value: '#9bca3e', replacement: 'colors.green[6]' },
    colorGreenLight: {
        value: polished_1.lighten(colorOffsetLight, '#9bca3e'),
        replacement: 'colors.green[7]'
    },
    colorGreenDark: {
        value: polished_1.darken(colorOffsetDark, '#9bca3e'),
        replacement: 'colors.green[5]'
    },
    colorRed: { value: '#bd2527', replacement: 'colors.red[3]' },
    colorRedLight: {
        value: polished_1.lighten(colorOffsetLight, '#bd2527'),
        replacement: 'colors.red[4]'
    },
    colorRedDark: {
        value: polished_1.darken(colorOffsetDark, '#bd2527'),
        replacement: 'colors.red[2]'
    },
    colorYellow: { value: '#ffd24d', replacement: 'colors.gold[6]' },
    colorYellowLight: {
        value: polished_1.lighten(colorOffsetLight, '#ffd24d'),
        replacement: 'colors.gold[7]'
    },
    colorYellowDark: {
        value: polished_1.darken(colorOffsetDark, '#ffd24d'),
        replacement: 'colors.gold[5]'
    },
    colorPink: { value: '#d91698', replacement: 'colors.violet[3]' },
    colorPinkLight: {
        value: polished_1.lighten(colorOffsetLight, '#d91698'),
        replacement: 'colors.violet[4]'
    },
    colorPinkDark: {
        value: polished_1.darken(colorOffsetDark, '#d91698'),
        replacement: 'colors.violet[2]'
    },
    colorPurple: { value: '#9545e5', replacement: 'colors.violet[3]' },
    colorPurpleLight: {
        value: polished_1.lighten(colorOffsetLight, '#9545e5'),
        replacement: 'colors.violet[4]'
    },
    colorPurpleDark: {
        value: polished_1.darken(colorOffsetDark, '#9545e5'),
        replacement: 'colors.violet[2]'
    },
