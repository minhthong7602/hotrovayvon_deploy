...
function objectSortByScore(obj, getScore) {
  var sortedKeys = (0, _objectReduce2.default)(obj, function (sortedKeys, value, key) {
    var index = sortedKeys.findIndex(function (el) {
      return getScore(obj[el], el) > getScore(value, key);
    });

    if (index !== -1) {
      return (0, _insertAtIndex2.default)(sortedKeys, key, index);
    }

    return [].concat(_toConsumableArray(sortedKeys), [key]);
  }, []);
